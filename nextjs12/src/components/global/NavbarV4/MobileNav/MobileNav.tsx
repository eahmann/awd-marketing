    ...
    >
      <Popover.Panel className="absolute z-10 flex flex-col flex-grow w-screen h-full min-h-screen -mx-4 -my-4 -mt-2 inset-x-4 top-1 transform">
        <div className="m-4 overflow-scroll rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
          <div className="sticky inset-0 z-40 p-4 bg-indigo-700 dark:bg-indigo-900">
            {" "}
            <div className="flex items-center justify-between">
              ...
              <div className="p-1">
                <Popover.Button className="inline-flex items-center justify-center p-2 text-gray-400 bg-white dark:bg-gray-100 rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
          ...
          <div className="relative px-5 py-6 bg-indigo-600 dark:bg-indigo-700 grid gap-6 sm:gap-8 sm:p-8">
