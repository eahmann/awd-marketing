  ...
  return (
    <CustomLinkV2
      ...
      className={classNames(
        "px-2 group leading-8 rounded-lg   md:px-2 focus:bg-transparent focus:ring-2 focus:outline-none focus:ring-offset-2 focus:ring-brand-500 focus:ring-offset-kashmir-blue-500",
